...
public class Writer extends DefaultFilter {
    ...
    protected void doAugs(Augmentations augs) {
        HTMLEventInfo evInfo = (augs == null) ? null : (HTMLEventInfo) augs.getItem("http://cyberneko.org/html/features/augmentations");
        if (evInfo != null) {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        org.apache.xerces.xni.parser.XMLParserConfiguration parser = new org.cyberneko.html.HTMLConfiguration();
